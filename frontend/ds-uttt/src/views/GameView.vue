...
<template>
  ...
  <div class="grid" id="main_game">
        <!-- 9 Haupt-DIVs -->
        <div class="cell" id="game_1" >
            <!-- 9 Unter-DIVs pro Haupt-DIV -->
            <div @click="makeMove(1,1)" class="sub-cell"></div>
